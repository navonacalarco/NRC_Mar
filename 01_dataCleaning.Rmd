...
df_behaviours_1 <- df_behaviours[, c(
  'Bhv3', #03. I often skim things that I read online to get the gist of them.	
  'Bhv4', #04. I often skim things that I read in hard copy (i.e., offline) to get the gist of them.	
  'Bhv5'  #05. I can easily stop reading something if I don't find it worth my while.
)]
