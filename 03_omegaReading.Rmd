...
__Description.__  
This notebook details the code used to run categorical omega on the NRC reading scales. We use categorical as the scales only have X options; thus, should not be considered continuous. Right, wrong. Binary. 
...
#read in test df
df_analogies <- read.csv(dir('../NRC_data/out', full.names=T, pattern="^df_analogies_"))
df_sentences <- read.csv(dir('../NRC_data/out', full.names=T, pattern="^df_sentences_"))
df_synonyms <- read.csv(dir('../NRC_data/out', full.names=T, pattern="^df_synonyms_"))
